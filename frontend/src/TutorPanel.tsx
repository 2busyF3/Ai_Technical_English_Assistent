  ...
  const send=async(text?:string)=>{
    ...
    try{
      await streamTutor(
        ...
        {
          meta:data=>{setSessionId(data.session_id);setProvider({provider:String(data.provider),model:String(data.model)});},
